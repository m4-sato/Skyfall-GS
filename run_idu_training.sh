#!/bin/bash
# IDU Training with FlowEdit - Working Configuration
# Date: 2026-03-01
# GPU: 11.73 GiB VRAM
# Successfully completed 10000 iterations
...
OUTPUT_PATH="./outputs/JAX_idu/JAX_068"
CHECKPOINT="./outputs/JAX/JAX_068/chkpnt30000.pth"
